...
export const fixStorybug = (Tooltip.displayName = 'YobtaTooltip')
...
The offset property determines the size of the tooltip dot and the distance between the elements.
...
<Canvas>
  <Story name="Offset">
    <Toggle>
      ...
      <Tooltip id="strict-tooltip" offset={12} visible>
        A hint
      </Tooltip>
    </Toggle>
  </Story>
